...
addBtn.addEventListener("click", function (elem) {
    ...
    notesObj.push({title: titleTxt.value, link: addTxt.value});
...
function showNotes() {
    ...
    notesObj.forEach(function (element, index) {
        html += `<div class="noteCard my-2 mx-2 card" style="width: 18rem; border: none;">
            <div class="card-body">
    ...
    if (notesObj.length != 0){
        ...
        notesElem.innerHTML = `<p style='color:white;'>You have not any Notes to show."Click on Add Note" to create Your Notes</p>`
    }
}
